...
class TestLSTMAttentionModel:
    ...
    def test_forward(self):
        ...
        model = LSTMAttentionModel(
            input_dim=5, output_dim=1, hidden_dim=32, num_layers=2
        )
...
class TestNeuralODEModel:
    ...
    def test_explain_trajectory(self):
        ...
        try:
            ...
            model = NeuralODEModel(
                input_dim=5, latent_dim=8, solver="euler", use_adjoint=False
            )
...
class TestModelRegistry:
    ...
    def test_list_available(self):
        ...
        # Import to register
        from src.models import mlp, lstm_attn  # noqa: F401
