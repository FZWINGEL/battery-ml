...
class LGBMModel:
    ...
    def __init__(
        ...
        self._use_feature_names: bool = (
            False  # Track if feature names were explicitly provided
        )
    ...
    def fit(
        ...
        if self._use_feature_names:
            ...
            X_val_df = (
                pd.DataFrame(X_val, columns=self.feature_names_)
        ...
        callbacks = (
            [lgb.early_stopping(self.early_stopping_rounds)] if eval_set else None
        )
